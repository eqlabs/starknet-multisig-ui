...
export const ClockCounterClockwise = ({css, width="24", height="24", viewBox="0 0 24 24", className}: IconProps) => (
  <svg className={`icon${className ? " " + className : ""}`} width={width} height={height} viewBox={viewBox} fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const House = ({css, width="24", height="25", viewBox="0 0 24 25", className}: IconProps) => (
  <svg className={`icon${className ? " " + className : ""}`} width={width} height={height} viewBox={viewBox} fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const PencilLine = ({css, width="16", height="17", viewBox="0 0 16 17", className}: IconProps) => (
  <svg className={`icon${className ? " " + className : ""}`} width={width} height={height} viewBox={viewBox} fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const Hourglass = ({css, width="24", height="24", viewBox="0 0 24 24", className}: IconProps) => (
  <svg className={`icon${className ? " " + className : ""}`} width={width} height={height} viewBox={viewBox} fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const SquareArrow = ({css, width="24", height="24", viewBox="0 0 24 24", className}: IconProps) => (
  <svg className={`icon${className ? " " + className : ""}`} width={width} height={height} viewBox={viewBox} fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const Note = ({css, width="16", height="17", viewBox="0 0 16 17", className}: IconProps) => (
  <svg className={`icon${className ? " " + className : ""}`} width={width} height={height} viewBox={viewBox} fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const User = ({css, width="16", height="17", viewBox="0 0 16 17", className}: IconProps) => (
  <svg className={`icon${className ? " " + className : ""}`} width={width} height={height} viewBox={viewBox} fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const Caret = ({css, width="17", height="10", viewBox="0 0 17 10", className}: IconProps) => (
  <svg className={`icon${className ? " " + className : ""}`} width={width} height={height} viewBox={viewBox} fill="none" xmlns="http://www.w3.org/2000/svg">
