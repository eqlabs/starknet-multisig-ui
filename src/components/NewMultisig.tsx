    ...
    <div>
      {!deploying ? (
        <Fieldset css={{ gap: "0" }}>
          ...
          <hr />
          <Paragraph>
            Your contract will have one or more signers. We have prefilled the first signer with
            your connected wallet details, but you are free to change this to a different signer.
          </Paragraph>
          ...
          <InnerContainer>
            {signers.map((signer, i) => (
              <Field
                key={i}
                inactive={signers.length > 1 && i === totalSigners.valueOf() && signer === ""}
              >
          ...
          <Paragraph>
            ...
            general, the more confirmations required, the more secure your contract is.
          </Paragraph>
            ...
            >
              ...
              >
                {[...Array(totalSigners).keys()].map((_, index) => {
                  ...
                  return (
                    <option
                      value={thresholdOption.toString()}
                      key={`thresholdOption-${thresholdOption.toString()}`}
                    >
                      {thresholdOption.toString()}
                    </option>
                  )
                })}
              </Select>{" "}
          ...
          >
            ...
            <Button css={{ flexGrow: "1" }} onClick={onDeploy}>
