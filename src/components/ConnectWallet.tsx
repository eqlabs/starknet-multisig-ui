...
const FrontPageWrapper = styled(motion.div, {
...
export const ConnectWallet = () => {
  ...
  useEffect(() => {
    if (pendingWallet && accountInterface) {
      state.walletInfo = {
        id: pendingWallet.id,
        address: accountInterface.address
      }
      ...
      {!pendingWallet ? (
        <>
          ...
          >
            ...
            >
              StarSign is an open-source project that lets you create and sign multisig contracts on
              the StarkNet. Starsign works on your browser and currently supports{" "}
              <a href="https://www.argent.xyz/argent-x/" target="_blank" rel="noreferrer noopener">
                ArgentX
              </a>{" "}
              &{" "}
              ...
              <br />
              <a
                href="https://github.com/eqlabs/starknet-multisig-ui"
                target="_blank"
              ...
              , and{" "}
              <a href="https://discord.gg/Dt5a5Uus3t" target="_blank" rel="noreferrer noopener">
                ask for support on our Discord
              </a>
              .
            </Paragraph>
